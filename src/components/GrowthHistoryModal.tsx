...
interface GrowthRecord {
    round?: number;
    created_at?: string; // 👈 เปลี่ยนเป็น optional
    weight_kg: number | null; // 👈 เปลี่ยนเป็น number
    height_cm: number | null; // 👈 เปลี่ยนเป็น number
    remarks?: string;
                        ...
                        >
                            ...
                            >
                                ...
                                <Typography
                                    ...
                                    sx={{ fontFamily: "Kanit, Poppins" }}
                                >
                                    {rec.growthResult.weightResult} |{" "}
                                    {rec.growthResult.heightResult}
                                </Typography>
                            </Box>
                        </Box>
                    ))
